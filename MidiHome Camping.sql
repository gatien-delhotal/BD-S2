...
(idClient VARCHAR(5), nomClient VARCHAR(25), prenomClient VARCHAR(25), villeClient VARCHAR(25), 
...
INSERT INTO Clients (idClient, nomClient, prenomClient, villeClient) (SELECT * FROM Palleja.CAMP_Clients);
INSERT INTO Campings (idCamping, nomCamping, villeCamping, nbEtoilesCamping)(SELECT * FROM Palleja.CAMP_Campings);
INSERT INTO Bungalows (idBungalow, nomBungalow, superficieBungalow, idCamping)(SELECT * FROM Palleja.CAMP_Bungalows);
INSERT INTO Locations (idLocation, idClient, idBungalow, dateDebut, dateFin, montantLocation)(SELECT * FROM Palleja.CAMP_Locations);
INSERT INTO Services (idService, nomService, categorieService)(SELECT * FROM Palleja.CAMP_Services);
INSERT INTO Proposer (idBungalow, idService)(SELECT * FROM Palleja.CAMP_Proposer);
INSERT INTO Employes (idEmploye, nomEmploye, prenomEmploye, salaireEmploye, idCamping, idEmployeChef)(SELECT * FROM Palleja.CAMP_Employes);
